...
def reconstruir_menu_completo():
    ...
    try:
        ...
        # 1. Borramos la tabla vieja que tiene el nombre de columna incorrecto
        cur.execute("DROP TABLE IF EXISTS productos;")
        
        # 2. Creamos la tabla nueva con la columna 'imagen' bien definida
        cur.execute('''
        ...
        # 3. La lista oficial de Sr. Campero (Tus 4 clásicos + Todo lo nuevo)
        menu_oficial = [
        ...
        cur.close()
        conn.close()
        print("--- ¡TABLA RECONSTRUIDA Y MENÚ COMPLETO CARGADO AL 100%! ---")
    except Exception as e:
        print("Error en reconstrucción:", e)

# Forzamos la ejecución de la nueva estructura
